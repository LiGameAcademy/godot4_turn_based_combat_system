extends Node2D
class_name BaseCombatCharacter
...
## 应用技能状态
func apply_skill_status(status_instance: SkillStatusData, source_character: Node, effect_data_from_skill: SkillEffect) -> Dictionary:
	if skill_component:
